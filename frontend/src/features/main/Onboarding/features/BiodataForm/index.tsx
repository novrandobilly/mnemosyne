  ...
  return (
    <div className="relative min-h-screen bg-neutral-50 text-neutral-900">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-24 top-20 h-80 w-80 rounded-full bg-emerald-200/40 blur-[120px]" />
        <div className="absolute right-10 top-10 h-56 w-56 rounded-full bg-neutral-200/70 blur-[100px]" />
        <div className="absolute bottom-16 right-1/3 h-48 w-48 rounded-full bg-amber-100/70 blur-[90px]" />
      </div>

      <div className="relative flex min-h-screen items-start justify-center px-4 py-16 sm:px-6">
