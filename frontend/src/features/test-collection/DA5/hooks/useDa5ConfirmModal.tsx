...
export const useDa5ConfirmModal = () => {
  const navigate = useNavigate();
  const { showModal, closeModal } = useModal();

  const handleStart = () => {
    sessionStorage.removeItem("da5_progress");
    sessionStorage.removeItem("da5_seconds_left");
    navigate("/psikotes/da5/test-start");
    closeModal();
  };
