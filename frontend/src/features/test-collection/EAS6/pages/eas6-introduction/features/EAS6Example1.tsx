        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-8 gap-x-1 sm:gap-x-2 font-mono text-sm font-semibold text-neutral-900">
              {exampleRow.question.trim().split(/\s+/).map((item, idx) => (
            ...
            {exampleRow.options.map((option) => {
              ...
              return (
                <button
                  ...
                  disabled
                  className={cn(
                    "flex min-w-12 sm:min-w-14 items-center justify-center rounded-xl border px-3 py-1.5 transition-all duration-150 cursor-default relative overflow-hidden",
                    isSelected
