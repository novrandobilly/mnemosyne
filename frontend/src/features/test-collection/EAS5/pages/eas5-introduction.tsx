...
export const Eas5Introduction = () => {
  ...
  const [interactiveAnswers, setInteractiveAnswers] = useState<Record<string, number | null>>({
    A: null,
    B: null,
    C: null,
    D: null,
      ...
      content: (
        <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm space-y-4">
          ...
          <IntiDinamisText size="14" className="text-neutral-600 leading-relaxed">
            Anda akan memulai tes <span className="font-semibold text-neutral-900">EAS5 - Space Visualization</span>. 
    ...
    <MainWrapper pageTitle="Petunjuk EAS5">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm space-y-4">
          <IntiDinamisText as="h2" size="16" weight="bold" className="text-neutral-900 uppercase tracking-wide">
            PETUNJUK :
          </IntiDinamisText>
          <IntiDinamisText size="14" className="text-neutral-700 leading-relaxed">
            Anda akan dihadapkan pada serangkaian gambar berupa tumpukan balok yang besarnya sama persis satu sama lainnya. 
            Pada beberapa balok diberi huruf A, B, C, D, dan E.
          </IntiDinamisText>
          <IntiDinamisText size="14" className="text-neutral-700 leading-relaxed">
            Tugas Anda adalah menentukan berapa jumlah balok yang menempel baik satu sisi penuh atau sebagian dari salah satu sisinya 
            pada masing-masing balok yang diberi huruf. Untuk balok yang hanya bersinggungan sudutnya tidak dianggap menempel.
          </IntiDinamisText>

          <div className="rounded-xl bg-neutral-50 p-4 border border-neutral-100">
            <IntiDinamisText size="14" weight="semibold" className="text-neutral-900">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm space-y-6">
          <IntiDinamisText as="h3" size="14" weight="bold" className="text-neutral-900 uppercase tracking-wide">
            CONTOH :
          </IntiDinamisText>
          ...
          <div className="space-y-8 divide-y divide-neutral-100">
            ...
            <div className="grid grid-cols-1 gap-6 pt-2 lg:grid-cols-[280px_1fr]">
              <div className="overflow-hidden rounded-xl border border-neutral-200 h-64 bg-neutral-100">
                <img
                  src="https://placehold.co/400x400?text=EAS5+Contoh+1"
                  alt="Example Pile 1"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {EXAMPLE_1_ROWS.map((row, idx) => (
                    <div key={idx} className="flex items-center gap-4 rounded-xl border border-neutral-200 bg-white p-3 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-6 pt-6 lg:grid-cols-[280px_1fr]">
              <div className="overflow-hidden rounded-xl border border-neutral-200 h-64 bg-neutral-100">
                <img
                  src="https://placehold.co/400x400?text=EAS5+Contoh+2"
                  alt="Example Pile 2"
                  className="h-full w-full object-cover"
                />
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <IntiDinamisText size="12" className="text-neutral-400 mt-1">
                    Cobalah menjawab soal-soal di bawah ini berdasarkan tumpukan balok di sebelah kiri.
                  </IntiDinamisText>
                </div>
                        ...
                        {isAnswered && (
                          <div className="w-16 text-right pr-2">
                            {isCorrect ? (
                              ...
                              <span className="text-xs font-semibold text-rose-600">Salah</span>
                            )}
                          </div>
                        )}
                      </div>
